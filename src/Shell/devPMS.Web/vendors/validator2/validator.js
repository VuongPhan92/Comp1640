    ...
    */
    mark = function( field, text ){
        ...
        if( item.hasClass('has-error') ){
            if( defaults.alerts )
                item.find('.'+'<i class="fa fa-times-circle-o" style="color:red"></i>');
        }


        else if( defaults.alerts ){
            warning = $( '<i class="fa fa-times-circle-o" style="color:red" ></i>' );
    ...
    */
    unmark = function( field ){
        ...
        field.closest('.' + defaults.classes.item)		
			 ...
			 .find('fa fa-times-circle-o').removeClass();
    };
